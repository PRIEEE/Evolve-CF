...
class DNN(nn.Module):
    def __init__(self, user_num, item_num, factor_num):
        ...
        DNN_modules.append(nn.Linear(input_size, 160))
        DNN_modules.append(nn.ReLU())
        DNN_modules.append(nn.Dropout(p=0.0))
        DNN_modules.append(nn.Linear(160, 200))
        DNN_modules.append(nn.ReLU())
        DNN_modules.append(nn.Dropout(p=0.1))
        DNN_modules.append(nn.Linear(200, 100))
        DNN_modules.append(nn.ReLU())
        DNN_modules.append(nn.Dropout(p=0.1))
        DNN_modules.append(nn.Linear(100, 50))
        DNN_modules.append(nn.ReLU())
        DNN_modules.append(nn.Dropout(p=0.0))
        DNN_modules.append(nn.Linear(50, 40))
        DNN_modules.append(nn.ReLU())
        DNN_modules.append(nn.Dropout(p=0.0))
        DNN_modules.append(nn.Linear(40, factor_num))
        DNN_modules.append(nn.ReLU())
...
for K in [8, 16, 32, 64]:  # latent factors
    ...
    print("%3d%20d%20.6f%20.6f" % (K, 30, best_hr, best_ndcg))